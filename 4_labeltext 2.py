...
#import raw data 
data = pd.read_csv('/Users/vyvo/Documents/GitHub/LinkedIn_dsjob/data/dsjob_wrangle.csv') #exp_level_v2: nan = Not Applicable 
...
jd_kw = pd.read_csv('~/Documents/GitHub/LinkedIn_dsjob/data/job_description.csv')
jr_kw = pd.read_csv('~/Documents/GitHub/LinkedIn_dsjob/data/job_requirement.csv')
...
data.drop(columns=['clean_description','main_description','label']).to_csv('datafull.csv',index=False)
